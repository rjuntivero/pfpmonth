...
import { RootState } from '@/state/store'; // adjust if your root state type path differs
...
export default function CharacterInitWrapper({ character, participants }: Props) {
